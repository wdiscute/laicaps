package com.wdiscute.laicaps.registry;
...
public class ModItems
{
    ...
    public static final DeferredRegister.Items BLOCK_NO_DATAGEN = DeferredRegister.createItems(Laicaps.MOD_ID);
...
//    public static final DeferredItem<Item> SKYYFISH = ITEMS.register("skyyfish", () -> new Item(new Item.Properties().food(ModFoodProperties.BASIC_RAW_FISH)));
    ...
    public static void register(IEventBus eventBus)
    {
        ...
        BLOCK_NO_DATAGEN.register(eventBus);
    }
